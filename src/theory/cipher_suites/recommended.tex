...
Straight forward, the authors wanted strong ciphers, forward 
secrecy\footnote{\url{http://nmav.gnutls.org/2011/12/price-to-pay-for-perfect-forward.html}}
...
\item AES256-SHA as a last resort: with this cipher at the end, even server
      ...
      is meant to provide the same client coverage (e.g. support Microsoft crypto
